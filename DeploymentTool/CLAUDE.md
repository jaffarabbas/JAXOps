...
- Use `appsettings.json` as the source of truth for codebase paths, output roots, and the dark mode preference.
...
- The Settings tab owns the persisted dark mode toggle, and changing it should update the current theme immediately.
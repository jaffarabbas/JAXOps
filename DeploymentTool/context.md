...
- `IsDarkMode`: persisted UI theme flag controlled from the Settings tab.
...
- Keep theme colors resource-driven so the persisted dark mode setting can switch the full UI without rewriting control logic.
